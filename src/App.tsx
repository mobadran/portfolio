...
import { CmsContentProvider, type CmsContent } from './context/CmsContentContext';
...
import { PageContextProvider, usePage } from './context/PageContext';
import TerminalGrid from './components/TerminalGrid';

const IMAGES = ['/wallpaper.webp'];
...
export default function App() {
  ...
  return (
    <>
      <Loader imageUrls={IMAGES} />
      <CmsContentProvider value={cmsContent!}>
        <PageContextProvider>
          {currentPage === 'home' ? (
            <div className="flex h-screen flex-col">
              <Header content={cmsContent?.header || null} />
              <div className="flex grow flex-col" id="mainGUI">
                <div className="flex grow flex-col items-center justify-evenly gap-8 p-8 pb-0">
                  ...
                  <section className="flex max-w-250 flex-col items-center gap-4">
                    <span className="glow text-center text-2xl font-bold text-white/80 lg:text-5xl">
                    ...
                    <p className="text-center text-lg text-white/80 lg:text-2xl">
                      <strong>MERN Stack</strong> Developer with experience in <strong>Next.js</strong> and{' '}
                      <strong>MySQL</strong>. Looking for opportunities to grow as a developer and contribute to solid
                      teams. Also, I love <strong>cats!</strong> 😸
                    </p>
                    {/* <SpotlightButton /> */}
                    <ContactButton />
                  </section>
                  ...
                  <section className="w-full lg:max-w-200">
                    <ProjectSlider projects={cmsContent?.projects || []} />
                  </section>
                </div>
                <Attribution />
              </div>
